...
#include "IntVectorIterator.h" // Include IntVectorIterator
...
const int IntVectorIterator::operator*() 
const {
...
bool IntVectorIterator::operator==(const IntVectorIterator& aRHS) 
const {
	return
...
IntVectorIterator IntVectorIterator::begin() 
const {
...
IntVectorIterator IntVectorIterator::end() 
const {
	IntVectorIterator iter = *this;
