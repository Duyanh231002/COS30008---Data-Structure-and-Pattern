...
#define P1 // Uncomment #define P1 uncomment #define P1 Problem 01 implementation
#define P2 // Uncomment #define P2 uncomment #define P2 Problem 02 implementation
